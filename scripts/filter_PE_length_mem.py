...
filtered_total = 0
filtered_each = 0
filtered_each_1 = 0 # switch the order of pair-end filtering and each-end filtering
filtered_total_2 = 0 # switch the order of pair-end filtering and each-end filtering
total_bases = 0
