...
################################################################################
##  *
##  *  Function: prepare dag file to run the WGS pipeline on CHTC, from pair-end reads to SNP]
##  *  Writer:Siyuan Feng
...
input_file = '/staging/sfeng77/dataset/suzukii_WGS/input_list.txt' # input table of fastq files containing PE reads for each sample
dag_input = '/home/sfeng77/jobs/test_pipeline/pipeline.dag' # dagman file that will be submitted to the HTCondor scheduler
...
software_pack = '/home/sfeng77/biosoft/biosoft' # software path that contains bamdst (not available with conda)
conda_pack_squid = 'http://proxy.chtc.wisc.edu/SQUID/sfeng77/suzukii_WGS/WGS_analysis.tar.gz'   # packed conda environment for most analyses
conda_pack_align_squid = 'http://proxy.chtc.wisc.edu/SQUID/sfeng77/suzukii_WGS/align.tar.gz'    # packed conda environment for alignment
bwa_index_squid = 'http://proxy.chtc.wisc.edu/SQUID/sfeng77/suzukii_WGS/GCF_013340165.1_LBDM_Dsuz_2.1.pri_genomic.fna.bwa_index.tar.gz' # bwa index of reference genomic sequence
genome_seq_squid = 'http://proxy.chtc.wisc.edu/SQUID/sfeng77/suzukii_WGS/GCF_013340165.1_LBDM_Dsuz_2.1.pri_genomic.fna.tar.gz'  # reference genomic sequence (.fasta) and an fasta index (.fai) to allow fast access to the genome 
genome_ann_squid = 'http://proxy.chtc.wisc.edu/SQUID/sfeng77/suzukii_WGS/GCF_013340165.1_LBDM_Dsuz_2.1.pri_genomic.annotation.tar.gz'   # genomic annotation files in .gff and .gtf formats
genome = 'WT3-2.0'  # name of the reference genome
ann_version = 'Dsuz-WT3_v2.0_refseq'    # self-defined version of snpEff genomic annotation
genome_info = 'Dsuz-WT3_v2.0_refseq.genome : Drosophila Suzukii'    # self-defined name of snpEff genomic annotation
split_lines = 100000
